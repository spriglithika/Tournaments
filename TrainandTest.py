...
if __name__ == '__main__':
    ...
    scheduler = torch.optim.lr_scheduler.CosineAnnealingLR(optimizer, T_max=cfg.get('train.num_epochs', 10), eta_min=cfg.get('train.lr_min', 1e-5)) if cfg.get('train.use_scheduler', False) else None
    ...
    if not args.just_test:
        for epoch in range(1, num_epochs + 1):
            ...
            if val_split > 0:
                ...
                ece, _, _, _ = eval_ece(model, val_loader, 20)
