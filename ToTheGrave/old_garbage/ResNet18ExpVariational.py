...
from old_garbage.Models import BaseModel, MidModel, TournamentModelVariational, copy_matching_parameters
from old_garbage.Training_testing_old import joint_train_all_mixup, joint_eval_all, joint_train_all_variational, ConvergenceMonitor, joint_eval_all_var
from argparse import ArgumentParser
TournamentModel = TournamentModelVariational
...
def main(num_epochs, path_mod):
    ...
    ckpt_base = f'ckpts/cifar100/resnet18/variational{_path_mod}'
    ...
    for epoch in range(num_epochs):
        ...
        # joint_train_all_variational(device, train_loader, models, class_count, temps = [1,1,1], lbda = [0.01, 0.001, 0.005])
        joint_train_all_variational(device, train_loader, models, class_count, temps = [1,1,1], lbda = [0.01, 0.001, 0.001])
        joint_eval_all_var(device, val_loader, models, class_count, monitor=monitor, epoch=epoch)
