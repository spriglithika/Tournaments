...
from old_garbage.Models import BaseModel, MidModel, copy_matching_parameters, NeuralIsingTournament, NeuralIsingTournamentFull
...
def main(checkpoint_path):
    ...
    class_count = 100
    # image_shape = train_dataset[0][0].shap
    ...
    joint_eval_all(device, val_loader, models, class_count, monitor=None, epoch=None)
