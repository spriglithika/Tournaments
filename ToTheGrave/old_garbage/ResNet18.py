...
from old_garbage.Models import BaseModel, MidModel, NeuralIsingTournamentFull, copy_matching_parameters
from old_garbage.Training_testing_old import joint_train_all_ising, joint_eval_all, joint_train_all_balanced, ConvergenceMonitor
...
def main(num_epochs, path_mod):
    train_dataset = datasets.MNIST('../data', train=True, download=True,
                                transform=transforms.Compose([
                                    ...
                                    transforms.Grayscale(num_output_channels=3),       # make 3-channel RGB-like image
    ...
    ckpt_base = f'ckpts/cifar100/resnet18/balanced{_path_mod}'
    ...
    for epoch in range(num_epochs):
        ...
        joint_train_all_ising(device, train_loader, models, class_count, temps = [1,1, 1], lbda = [1, 1,1])
