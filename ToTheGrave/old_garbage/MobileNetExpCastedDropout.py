...
from old_garbage.Models import BaseModel, MidModel, copy_matching_parameters, TournamentModelDropout
...
def main(num_epochs, path_mod):
    ...
    ckpt_base = f'ckpts/cifar100/mobilenet_dropout{_path_mod}'
    monitor = ConvergenceMonitor(patience=3, mode='max', save_dir=ckpt_base)

    print("Starting joint training...")
    for epoch in range(num_epochs):
        print(f"Epoch {epoch}")
        joint_train_all_separate(device, train_loader, models, class_count)
