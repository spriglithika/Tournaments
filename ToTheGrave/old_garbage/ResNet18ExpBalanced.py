...
from old_garbage.Training_testing_old import joint_train_all_mixup, joint_eval_all, joint_train_all_balanced, ConvergenceMonitor
...
def main(num_epochs, path_mod):
    ...
    for epoch in range(num_epochs):
        ...
        joint_train_all_balanced(device, train_loader, models, class_count, temps = [1,1, 1], lbda = [2, 1,.01])
